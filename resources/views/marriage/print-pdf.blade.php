    ...
    <div class="container">
        ...
        <div class="couple-names">
            ...
            <div class="marriage-date">
                Akan menikah pada
                <br><strong>{{ \Carbon\Carbon::parse($marriage->marriage_date)->locale('id')->isoFormat('dddd, D MMMM YYYY') }}</strong>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="col-value">
                        {{ \Carbon\Carbon::parse($marriage->groom_birth_date)->locale('id')->isoFormat('D MMMM YYYY') }}
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div class="section">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="col-label">Tanggal Lahir</div>
                    <div class="col-value">
                        {{ \Carbon\Carbon::parse($marriage->bride_birth_date)->locale('id')->isoFormat('D MMMM YYYY') }}
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div class="section wedding-details">
            ...
            <div class="detail-row">
                ...
                <div class="detail-value">
                    <strong>{{ \Carbon\Carbon::parse($marriage->marriage_date)->locale('id')->isoFormat('D MMMM YYYY') }}</strong>
                </div>
            </div>
        ...
        <div class="registration-info">
            <div style="margin-bottom: 3px;">
                <strong>Nomor Pengajuan:</strong> <span
                    class="registration-number">#{{ str_pad($marriage->id, 6, '0', STR_PAD_LEFT) }}</span>
            </div>
            <div style="margin-bottom: 3px;">
                <strong>Tanggal Pengajuan:</strong> {{ $marriage->created_at->locale('id')->isoFormat('D MMMM YYYY') }}
            </div>
            <div>
        ...
        <div class="footer">
            ...
            <div style="margin-top: 2mm; font-size: 8px;">
                Dicetak pada {{ now()->locale('id')->isoFormat('D MMMM YYYY [pukul] HH:mm:ss') }}
            </div>
        </div>
    </div>
</body>
