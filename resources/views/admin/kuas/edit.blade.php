...
<div class="bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl shadow-lg p-8 mb-6">
    ...
    <p class="text-blue-100 text-lg">Perbarui informasi Kantor Urusan Agama</p>
</div>

<div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="p-6">
        <form action="{{ route('admin.kuas.update', $kua->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $kua->name) }}" required
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="address" id="address" rows="3" required
                        class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 @error('address') border-red-500 @enderror">{{ old('address', $kua->address) }}</textarea>
                    @error('address')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="phone" id="phone" value="{{ old('phone', $kua->phone) }}"
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email', $kua->email) }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="operating_hours" id="operating_hours" value="{{ old('operating_hours', $kua->operating_hours) }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="url" name="google_maps_link" id="google_maps_link" value="{{ old('google_maps_link', $kua->google_maps_link) }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="url" name="google_maps_embed" id="google_maps_embed" value="{{ old('google_maps_embed', $kua->google_maps_embed) }}"
                ...
                <div>
                    ...
                    <input type="number" name="order" id="order" value="{{ old('order', $kua->order) }}" min="0"
                ...
                <div class="flex items-center">
                    <label for="is_active" class="flex items-center cursor-pointer">
                        <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $kua->is_active) ? 'checked' : '' }}
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                ...
                <button type="submit"
                    ...
                    <i class="fas fa-save mr-2"></i> Perbarui KUA
                </button>
            </div>
        </form>
    </div>
